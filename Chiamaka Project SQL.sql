...
select Employee_Number, Gender, Department, Marital_Status, Monthly_Income from [Project 1]
where Department = 'Sales' and Marital_Status = 'Single' and Monthly_Income > 15000 
and Gender = 'Female'

--2. Find out the married female employees in sales department who travel frequently with less than 10k monthly income?
select Employee_Number, Gender, Marital_Status, Department, Business_Travel, Monthly_Income from [Project 1]
where Gender = 'Female' and Marital_Status = 'Married'
and Department = 'Sales' and Business_Travel = 'TravelFrequently'
...
select count(Employee_Number) from [Project 1]
where Performance_Rating >  3 and Job_Satisfaction > 1 and Monthly_Income < 10000

--4. Find out the employees in research and development who have a daily rate greater than 1200 and earn more than than 10k?
select Employee_Number, Department, Daily_Rate, Monthly_Income from [Project 1]
where Department = 'Research & Development' and Daily_Rate > 1200 and Monthly_Income > 10000

--5. How many employees above age 50 travel frequently and earn less than 5k monthly in research and development?
select count(Employee_Number) from [Project 1]
where Age > 50 and Business_Travel = 'TravelFrequently' and Monthly_Income < 5000
